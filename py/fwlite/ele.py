...
taus, tauLabel  = Handle("std::vector<pat::Electron>"), "slimmedElectrons"
...
for iev,event in enumerate(events):
    ...
    for j,t in enumerate(taus.product()):
        print "Electron pt %6.2f eta %+5.3f phi %+5.3f  energy %6.2f" % (t.pt(),t.eta(),t.phi(),t.energy())
        for pair in t.electronIDs():
